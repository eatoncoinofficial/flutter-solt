...
class Precaching {
  Future<bool> loadGraphics(BuildContext context) async {
    ...
    // await svg.cache.putIfAbsent(SvgAssetLoader(boardIc).cacheKey(null), () => SvgAssetLoader(boardIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(playButton).cacheKey(null), () => SvgAssetLoader(playButton).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(arrowLeftIc).cacheKey(null), () => SvgAssetLoader(arrowLeftIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(arrowRightIc).cacheKey(null), () => SvgAssetLoader(arrowRightIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(seventhIc).cacheKey(null), () => SvgAssetLoader(seventhIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(appleIc).cacheKey(null), () => SvgAssetLoader(appleIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(barIc).cacheKey(null), () => SvgAssetLoader(barIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(lemonIc).cacheKey(null), () => SvgAssetLoader(lemonIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(coinIc).cacheKey(null), () => SvgAssetLoader(coinIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(watermelonIc).cacheKey(null), () => SvgAssetLoader(watermelonIc).loadBytes(null));
    // await svg.cache.putIfAbsent(SvgAssetLoader(crownIc).cacheKey(null), () => SvgAssetLoader(crownIc).loadBytes(null));
